...
| `flags.first_message` | Bool | Whether the message is the author's first message in the channel (available in [nightly](../Help/#what-is-nightly-and-how-to-use-install-it) since ...) |
